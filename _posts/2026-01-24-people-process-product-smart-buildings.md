...
1.  **Entity Resolution**: Identifying that "AHU-1" in the maintenance log is the same as "Air Handler Unit 1" in the BMS.
2.  **Semantic Layering**: Applying the ontology defined by our "librarians" to map relationships (e.g., *Room 101* `IS_SERVED_BY` *VAV Box A*).
3.  **Graph Construction**: Linking these entities into a queryable network.
