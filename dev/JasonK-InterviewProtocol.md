...
*Based on an interview with Pierrette Renée Dagg for the Benton Institute for Broadband & Society*
...
*   **Creating Home Demand:** Jason worked with Merit to allow any student or teacher with an `EUP.K12.MI.US` login to dial into the internet for free via **MichNet**.
    *   *Impact:* This created the first wave of demand for home access as teachers began moving lessons online.
...
*   **On Economics:** Always demonstrate the economic benefits. Example: Helping Cloverland Electric understand the business case for infrastructure even if they couldn't be the ISP themselves.
