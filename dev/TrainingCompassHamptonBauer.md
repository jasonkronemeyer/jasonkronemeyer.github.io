...
1. **Missing infrastructure** (structural barrier)
2. **Unclear value** (motivational barrier)
3. **Uncertainty about affordability** (economic barrier)
...
1. **Missing infrastructure** = Opportunity gap (Sen's capabilities)
2. **Unclear value** = Aspiration gap (Appadurai's capacity to aspire)
3. **Uncertainty about affordability** = Opportunity barrier (Sen's conversion factors)
