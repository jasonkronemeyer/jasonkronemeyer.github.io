...
*A Compass-voice position paper for Project Compass / EUPConnect Collaborative — By Jason Kronemeyer*
...
The urgency is not abstract. The ESL comment window is the only formal opportunity this year to tell the Bureau what the list should fund, and it closes on July 30. At the same time, the NPRM is asking whether the program itself should be narrowed or reoriented. If the ESL stays silent on converged infrastructure while the modernization proceeding moves toward retrenchment, E-Rate could lock in a pre-digital definition of school infrastructure just when the nation's buildings need to be rewired.

The Eligible Services List still sorts the world into Category One (data transmission and Internet access — leased lit fiber, dark fiber, self-provisioned networks) and Category Two (internal connections, managed internal broadband, and basic maintenance — routers, switches, access points, and cabling). That taxonomy quietly assumes that "inside the walls" is a light lift — a few switches and access points sized to a modest per-student budget. The FY2026-2030 Category Two budget is set at just \$201.57 per student (floor \$30,175; \$66,385 for Tribal libraries). Across the Section 11x(6) school-infrastructure feasibility studies I have worked on — including work contributing to the Sault Area Public Schools 11x study and master plan, from the smallest rural districts to full multi-building campuses — that figure doesn't come close to what a modern building actually needs, because the modern building is no longer a network with lights; it is a **converged information, communications, and energy system**.
...
The modern network *is* the power distribution system. PoE now drives lighting, sensors, displays, access control, and IP audio; DC Fault-Managed Power Systems (FMPS), or Class 4 power distribution, extend that convergence safely from a centralized power node. This is not experimental technology: FMPS is a formally recognized power class, defined as ["Class 4" in Article 726 of the 2023 National Electrical Code](https://www.ecmag.com/magazine/articles/article-detail/class-4-fault-managed-power-systems-an-overview-of-this-new-classification-in-the-2023-nec) — the first new power class added to the Code in decades — and governed by the UL 1400-1 and UL 1400-2 safety standards. The North Dickinson feasibility work is built around exactly this architecture — a single central network and power location feeding the building over a hybrid fiber-and-copper backbone that supports Class 4 fault-managed power. A PoE lighting retrofit at one middle school used **30% fewer fixtures** and could be installed by the IT cabling team rather than licensed electricians on every run. Yet the ESL and its ineligible list still treat "electrical infrastructure" and anything "servicing only ineligible items" as off-limits. That boundary is an artifact of a pre-convergence era — and the fact that a nationally codified, UL-listed power technology has no place on the eligible-services list is itself a sign of how far the list has fallen behind.
...
- [FTTH Council Europe: Leveraging Fibre Network Benefits with Optical LAN Technology](https://www.ftthcouncil.eu/resources/all-publications-and-assets/2670/) — industry white paper documenting Optical LAN energy savings of up to ~70%, 40–56% upfront cost reductions, and ~50% lower total cost of ownership versus legacy switching.
- [Tellabs: Optical LAN Energy Usage Comparison](https://tellabs.com/optical-lan-energy-comparison-unveils-rippling-effect-for-building-power-and-cooling-savings/) — energy cost model showing ~60% savings in both network power and building air-conditioning load for an Optical LAN design serving 9,000 endpoints.
- [Lorincz, Čusto & Begušić: A Comprehensive Analysis of Methods for Improving and Estimating Energy Efficiency of Passive and Active FTTH Optical Access Networks](https://www.mdpi.com/1424-8220/25/19/6012) — peer-reviewed review (*Sensors*, 2025) of passive optical network energy efficiency, University of Split / Croatian Academy of Engineering.
- [NEC 2023 Article 726 — Class 4 Fault-Managed Power Systems](https://www.ecmag.com/magazine/articles/article-detail/class-4-fault-managed-power-systems-an-overview-of-this-new-classification-in-the-2023-nec) — overview of the new National Electrical Code classification for FMPS, governed by UL 1400-1 (systems) and UL 1400-2 (cable).
