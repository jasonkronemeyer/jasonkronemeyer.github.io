---
layout: post
title: "The Map Says Served. The Household Says Not Yet."
subtitle: "What a New BEAD Affordability Study Means for Michigan's Digital Opportunity Future"
date: 2026-08-07
...
tags:
  ...
  - Community Capacity
  - Digital Opportunity
excerpt: "A new TPRC study of more than 60,000 BEAD-eligible locations reveals that broadband availability and affordability often do not align. For Michigan, the findings suggest that the next phase of digital opportunity must focus not only on infrastructure, but also on sustainable adoption and community capacity."
---
...
The new research paper, [*Assessing the Broadband Service Gaps and Affordability Barriers in BEAD-Eligible Areas*](https://ssrn.com/abstract=5376384), highlights this distinction.[^1] The authors demonstrate that high-speed service availability and affordability often do not align. In many communities, broadband may be available but remain financially out of reach for the very households public investments are intended to benefit.[^1]
...
[^1]: Koduru, Laasya, Alejandro Alvarado Rojas, Angel Chavez Penate, Siyi Zhou, Francois Bar, Elizabeth Belding, Hernan Galperin, and Arpit Gupta. *Assessing the Broadband Service Gaps and Affordability Barriers in BEAD-Eligible Areas*. Proceedings of TPRC 53: The 53rd Research Conference on Communication, Information and Internet Policy, 2025. Available via SSRN: [SSRN Abstract](https://ssrn.com/abstract=5376384) and [DOI Landing Page](https://dx.doi.org/10.2139/ssrn.5376384).

[^2]: Galperin, Hernan, François Bar, Arpit Gupta, Elizabeth Belding, and Laasya Koduru. *Broadband Affordability and the BEAD Program: Analysis and Policy Recommendations*. USC Annenberg Research Network on International Communication, 2026. Available via the [Policy Brief](https://arnicusc.org/wp-content/uploads/2026/02/Policy-Brief-BEAD-3.pdf) and [USC Annenberg announcement](https://arnicusc.org/news/new-policy-brief-broadband-affordability-and-the-bead-program-analysis-and-policy-recommendations/).

https://broadbandusa.ntia.gov/funding-programs/broadband-equity-access-and-deployment-bead-program.

[^4]: Federal Communications Commission. [National Broadband Map](https://broadbandmap.fcc.gov/).

[^5]: Michigan High-Speed Internet Office (MIHI). [Michigan High-Speed Internet Office](https://www.michigan.gov/leo/bureaus-agencies/mihi).

[^6]: The affordability benchmark referenced in the paper defines affordable broadband service as costing no more than approximately 2% of monthly income for low-income households. This benchmark is widely used in broadband affordability research and policy discussions, though it is not established by federal statute.