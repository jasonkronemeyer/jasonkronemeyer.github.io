...
- Do not commit any files from this folder. It is listed in `.gitignore`.
- If you want a file added to the repo later, move or copy it out of this directory and add it explicitly.
