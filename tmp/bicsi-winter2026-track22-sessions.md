...
Note: I can extract the session *titles* and *detail links* reliably from the public schedule page. The full session descriptions live on the detail pages.
...
## Pre-Conference Masterclass: Power and Data to the Edge using Limited Energy Systems and Cabling
